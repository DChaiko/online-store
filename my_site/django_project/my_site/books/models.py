...
class Book(models.Model):
    ...
    serie = models.ForeignKey("directory.Serie", on_delete=models.PROTECT, blank=True, null=True)
    genre = models.ForeignKey("directory.Genre", on_delete=models.PROTECT, blank=True, null=True)
    ...
    publisher = models.ForeignKey("directory.Publisher", on_delete=models.PROTECT,  blank=True, null=True)
