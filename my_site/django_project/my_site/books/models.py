...
class Book(models.Model):
    ...
    author = models.ManyToManyField("directory.Author", blank=True, verbose_name='Автор')
    serie = models.ForeignKey("directory.Serie", on_delete=models.PROTECT, blank=True, null=True, verbose_name='Серия')
    genre = models.ForeignKey("directory.Genre", on_delete=models.PROTECT, blank=True, null=True, verbose_name='Жанр')
    ...
    publisher = models.ForeignKey("directory.Publisher", on_delete=models.PROTECT,  blank=True, null=True, verbose_name='Издатель')
